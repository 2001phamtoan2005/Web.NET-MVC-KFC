...
namespace DoAn.Controllers
{
    public class MainController : Controller
    {
        ...
        public ActionResult DangNhap(FormCollection f)
        {
            ...
            {
                ACCOUNT_CUSTOMER user = db.ACCOUNT_CUSTOMERs.SingleOrDefault(t=>t.USERNAME_CUSTOMER==user_name && t.PASSWORD_CUSTOMER==password);
                if (user != null)
                {
        ...
        public ActionResult DangKy(CUSTOMER new_kh,FormCollection f)
        {
            ...
            {
                int tk = db.ACCOUNT_CUSTOMERs.Where(t => t.USERNAME_CUSTOMER == username).ToList().Count;
                if (tk==0)
                {
                    //add table Account
                    ...
                    db.ACCOUNT_CUSTOMERs.InsertOnSubmit(new_tk);
        ...
        public ActionResult DoiMatKhau(FormCollection f,string makh)
        {
            ...
            ACCOUNT_CUSTOMER tk_kh = db.ACCOUNT_CUSTOMERs.SingleOrDefault(t => t.ID_CUSTOMER == makh);
