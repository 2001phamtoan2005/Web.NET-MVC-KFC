...
namespace DoAn.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult DangNhap_Admin(FormCollection f)
        {
            ...
            {
                ACCOUNT_EMPLOYEE user = db.ACCOUNT_EMPLOYEEs.SingleOrDefault(t => t.USERNAME_EMPLOYEE == user_name && t.PASSWORD_EMPLOYEE == password);
                if (user != null)
                {
        ...
        public ActionResult DetailReceipt(string mahd,string makh)
        {
            ...
            List<DETAIL_RECEIPT> list = db.DETAIL_RECEIPTs.Where(t => t.ID_RECEIPT == mahd).ToList();
        ...
        public ActionResult ShowAccountCustomer(string makh)
        {
            ...
            ACCOUNT_CUSTOMER list = db.ACCOUNT_CUSTOMERs.SingleOrDefault(t => t.ID_CUSTOMER ==makh);
            return View(list);
        }
